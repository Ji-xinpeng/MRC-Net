...
class Attention(nn.Module):
    def __init__(self,
        ...
        # self.postion_encoding = PositionalEncoding(dim, 0.)
...
class MyAttention(nn.Module):
    ...
    def forward(self, x, x_gap):
        ...
        v = self.v(x_gap).reshape(B, N, 1, self.num_heads, C // self.num_heads)
        qk = qk.to(x.device)
        v = v.to(x.device)
...
class PositionalEncoding(nn.Module):
    ...
    def forward(self, x):
        # print("postional encoding = ", x.shape, self.pe.shape)
...
class SpatialSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # spatial self-attention calculation
