...
ROOT_DATASET = '/home/ubuntu/Desktop/jixinpeng/'


def return_ucf101(modality):
    filename_categories = 101
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'UCF101_npys/'
        filename_imglist_train = ROOT_DATASET + 'UCF101_splits/for_tsm_code/ucf101train01.txt'
        filename_imglist_val = ROOT_DATASET + 'UCF101_splits/for_tsm_code/ucf101test01.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
...
def return_jester(modality):
    ...
    filename_categories =  ROOT_DATASET + "mynet/data/jester_annotation/jester-v1-labels.csv"
    if modality == 'RGB':
        prefix = '{:05d}.jpg'
        root_data = ROOT_DATASET + "Jester"
        filename_imglist_train = ROOT_DATASET + 'mynet/data/jester_annotation/train_videofolder.txt'
        filename_imglist_val = ROOT_DATASET + 'mynet/data/jester_annotation/val_videofolder.txt'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
